...
@RequestMapping(path = LeaguePaidAPI.ENTITY_API, produces = MediaType.APPLICATION_JSON_VALUE)
@Tag(name = Constants.league_paid_tag_name, description = Constants.league_paid_tag_description)
@PreAuthorize("hasRole('PAID')")
public class LeaguePaidAPI {

    protected static final String ENTITY_API = URIConstant.ENTITY_API + URIConstant.API_PAID;
